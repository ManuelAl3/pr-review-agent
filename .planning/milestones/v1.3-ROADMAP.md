...
- [x] **Phase 12: Installer Robustness** - Clean stale agent/command files on re-install while preserving user data (completed 2026-04-01)
...
**Plans:** 1/1 plans complete
Plans:
- [x] 12-01-PLAN.md — Add cleanStaleFiles helper and version detection to installer
...
| 12. Installer Robustness | v1.3 | 1/1 | Complete    | 2026-04-01 |
