# Requirements Archive: v1.3 Multi-Framework & Discoverability
...
- [x] **RTCOMPAT-03**: Installer cleans stale agent/command files on re-install while preserving user data (`findings.json`, `config.json`, `REVIEW-PLAN.md`)
